...
![PhonePe Pulse Dashboard - Executive Overview](assets/overview_dashboard.png)

*Executive Overview page — KPI cards, transaction growth trend, transaction type distribution, state-wise heatmap, and top 5 states by transaction amount.*
